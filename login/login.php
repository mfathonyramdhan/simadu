        ...
        <div class="col-lg-12 login-form">
          <form action="login.php" method="POST">
            <fieldset>
              ...
              <div class="form-group">
                <a href="forgot_password.php" style="color: white;">Forgot Password?</a> <a href="login_siswa.php" style="padding-left: 20px; color: white;">Bukan Admin ? Login disini</a>

                <select name="Bukan Admin ? Login Disini" id="cars">
                  <option>Volvo</option>
                  <option>Saab</option>
                </select>
              </div>
