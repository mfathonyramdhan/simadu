...
if (isset($_POST['update_student'])) {
    ...
    $existingNohpQuery = "SELECT id_siswa FROM siswa WHERE nohp_ortu = '$nohp_ortu' AND id_siswa != '$studentId'";
    ...
    $existingNohpResult = mysqli_query($connection, $existingNohpQuery);
    ...
    } elseif (mysqli_num_rows($existingNohpResult) > 0) {
        // NoHP Ortu already exists, show an alert and redirect to siswa.php
        echo "<script>alert('NoHP Ortu sudah ada di database.'); window.location.href = 'siswa_update.php?id';</script>";
